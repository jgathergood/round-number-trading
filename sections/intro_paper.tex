...
\begin{figure}[hbt!]
	\caption{Leftmost Stock Price Digit and Probability of Sale \textcolor{blue}{[EQ: Old samples]} }%
...
\begin{figure}[hbt!]
	\caption{Leftmost Stock Price Digit and Probability of Sale \textcolor{blue}{[EQ: New samples, defining patterns based on prices on login days]} }%
	\label{fig:left_digit_sell}%
	\centering%	
	\bigskip
	\subfigure[Price Increasing]{
	...
	\subfigure[Remaining]{
\includegraphics[width=0.45\textwidth]{figures/Left2remaining_probCI2.pdf}
\includegraphics[width=0.45\textwidth]{figures/2left_remaning2.pdf}	
	}
	\fignote{£$Y$ in the X-axes is equivalent to £$X+1$ (e.g., £X9 could include £0.19, £1.9, £19, etc., while £Y0 could include £0.20, £2.0, £20, etc., ).}
\end{figure}
...
\begin{figure}[hbt!]
	\caption{Leftmost Stock Price Digit and Probability of Sale \textcolor{blue}{[EQ: Samples based on market prices not restricted to login days. These samples show no effects. This is the only plot using these samples, it is here just for reference.]} }%
	\label{fig:left_digit_sell}%
	\centering%	
	\bigskip
	\subfigure[Price Increasing]{
		\includegraphics[width=0.55\textwidth]{figures/Left2increase_probCI2market.pdf}	
	}
	\subfigure[Price Decreasing]{
		\includegraphics[width=0.55\textwidth]{figures/Left2decrease_probCI2market.pdf}	
	}
	\subfigure[Remaining]{
		\includegraphics[width=0.55\textwidth]{figures/Left2remaining_probCI2market.pdf}	
	}
	\fignote{£$Y$ in the X-axes is equivalent to £$X+1$ (e.g., £X9 could include £0.19, £1.9, £19, etc., while £Y0 could include £0.20, £2.0, £20, etc., ). \textcolor{blue}{[EQ: there is some overlap between the remaining sample here and in the one in Figure 2.]}}
\end{figure}
\clearpage
\textcolor{blue}{[EQ: From here, everything else is showing results with the new samples using prices on login days!]}
\begin{figure}[hbt!]
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c   }{
		...
		\midrule
		\input{tables/reg_sample_age.tex} 
	}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c   }{
		...
		\midrule
		\input{tables/reg_sample_gender.tex} 
	}
	\fignote{The unit of observation is an investor $\times$ stock $\times$ day. The samples is restricted to login days. We include only quarters in which the stocks increased/decreased in price (regarding the first observation of the quarter) and change the left most digit at least once during the quarter. Only those stocks that have changed the left most digit are included. Regressions fit an intercept for the change in the left most digit at X0 and two slopes for the left (with values in the range -3 to 0, corresponding to X6 to X9) and right (with values in the range 0 to 5, corresponding to Y0 to Y5) values. The constant shows the probability to sell the stock at when the second digit is 9 (X9). The second digit over threshold dummy shows the jump in probability when the first digit changes and so the second digit becomes 0 (Y0). SE are clustered by account.}
\end{econtable}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c   }{
		...
		& \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} & \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} &  \\ 
		\midrule
		\input{tables/reg_sample_portfolio.tex} 
	}
	\fignote{The unit of observation is an investor $\times$ stock $\times$ day. The samples is restricted to login days. We include only quarters in which the stocks increased/decreased in price (regarding the first observation of the quarter) and change the left most digit at least once during the quarter. Only those stocks that have changed the left most digit are included. Regressions fit an intercept for the change in the left most digit at X0 and two slopes for the left (with values in the range -3 to 0, corresponding to X6 to X9) and right (with values in the range 0 to 5, corresponding to Y0 to Y5) values. The constant shows the probability to sell the stock at when the second digit is 9 (X9). The second digit over threshold dummy shows the jump in probability when the first digit changes and so the second digit becomes 0 (Y0). SE are clustered by account.}
\end{econtable}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c   }{
		...
		& \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} & \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} &  \\ 
		\midrule
		\input{tables/reg_sample_tenure.tex} 
	}
	\fignote{The unit of observation is an investor $\times$ stock $\times$ day. The samples is restricted to login days. We include only quarters in which the stocks increased/decreased in price (regarding the first observation of the quarter) and change the left most digit at least once during the quarter. Only those stocks that have changed the left most digit are included. Regressions fit an intercept for the change in the left most digit at X0 and two slopes for the left (with values in the range -3 to 0, corresponding to X6 to X9) and right (with values in the range 0 to 5, corresponding to Y0 to Y5) values. The constant shows the probability to sell the stock at when the second digit is 9 (X9). The second digit over threshold dummy shows the jump in probability when the first digit changes and so the second digit becomes 0 (Y0). SE are clustered by account.}
\end{econtable}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c   }{
		...
		& \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} & \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} &  \\ 
		\midrule
		\input{tables/reg_sample_stocks.tex} 
	}
	\fignote{The unit of observation is an investor $\times$ stock $\times$ day. The samples is restricted to login days. We include only quarters in which the stocks increased/decreased in price (regarding the first observation of the quarter) and change the left most digit at least once during the quarter. Only those stocks that have changed the left most digit are included. Regressions fit an intercept for the change in the left most digit at X0 and two slopes for the left (with values in the range -3 to 0, corresponding to X6 to X9) and right (with values in the range 0 to 5, corresponding to Y0 to Y5) values. The constant shows the probability to sell the stock at when the second digit is 9 (X9). The second digit over threshold dummy shows the jump in probability when the first digit changes and so the second digit becomes 0 (Y0). SE are clustered by account.}
\end{econtable}
...
\begin{figure}[hbt!]
	\caption{Probability of Topping-up \textcolor{blue}{[EQ: With the new samples, the pattern for the decreasing price sample is completely different. There is no clear pattern! The old pattern was driven by stocks in the old remaining sample, i.e., stocks that have not changed the first left digit during the quarter. I will delete these plots. But in case you want to see how they look like, they are here for now]}}%
	\label{fig:topup}%
	\centering%	
	\bigskip
	\subfigure[Price Increasing Sample]{
...
\begin{table}\footnotesize
	...
	\begin{adjustbox}{center}
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/reg_sample_increase_1.tex} 
		}
	\end{adjustbox}
	...
	\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.01 to \pounds10.1} \\>{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/reg_sample_increase_2.tex} 
	}
\end{adjustbox}
...
\begin{table}\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (A): Price = \pounds0.10 to \pounds1.00} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/reg_sample_decrease_1.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.00 to \pounds10.0} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/reg_sample_decrease_2.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (C): Price = \pounds10 to \pounds100} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/reg_sample_decrease_3.tex} 
		}
	\end{adjustbox}
\end{table}
