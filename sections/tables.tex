...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c c  }{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/reg_sample_increase_quarter.tex} 
	}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c c  }{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/reg_sample_decrease_quarter.tex} 
	}
...
\begin{econtable}[h]\footnotesize
	...
	\label{tab:regressions_portvalue}
	\estauto{l c c c c c   }{
		& \multicolumn{2}{c}{Prices Increasing Sample} &  \multicolumn{2}{c}{Prices Decreasing Sample} & \\ 
		%	\cmidrule(rr){2-7}
		& \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} & \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} &  \\ 
...
\begin{econtable}[h]\footnotesize
	...
	\label{tab:regressions_numstocks}
	\estauto{l c c c c c   }{
		& \multicolumn{2}{c}{Prices Increasing Sample} &  \multicolumn{2}{c}{Prices Decreasing Sample} & \\ 
		%	\cmidrule(rr){2-7}
		& \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} & \multicolumn{1}{c}{Below Median} & \multicolumn{1}{c}{Above Median} &  \\ 
