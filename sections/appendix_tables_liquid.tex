...
\begin{table}[ht]\footnotesize
	...
	\begin{adjustbox}{center}
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_increase_bin1p_quarter.tex} 
		}
	\end{adjustbox}
	...
	\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.01 to \pounds10.1} \\>{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/liquidreg_sample_increase_bin10p_quarter.tex} 
	}
	\end{adjustbox}
	...
	\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (C): Price = \pounds11 to \pounds101} \\>{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/liquidreg_sample_increase_bin1pound_quarter.tex} 
	}
	\end{adjustbox}
...
\begin{table}\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.00 to \pounds10.0} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_bin10p_quarter.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (C): Price = \pounds10 to \pounds100} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_bin1pound_quarter.tex} 
		}
	\end{adjustbox}
\end{table}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{lcccccccccc}{
		...
		\input{tables/liquidprices_samples_stats_month_year.tex} 
	}
...
\begin{table}[ht]\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (A): Monthly Sample} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_increase_month.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Annual Sample} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
				\input{tables/liquidreg_sample_increase_year.tex} 
		}
	\end{adjustbox}
...
\begin{table}\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (A): Monthly Sample} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_month.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Annual Sample} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_year.tex} 
		}
	\end{adjustbox}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c c  }{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/liquidreg_sample_increase_quarter_sell.tex} 
	}
...
\begin{econtable}[h]\footnotesize
	...
	\estauto{l c c c c c c  }{
		...
		\multicolumn{1}{c}{(5)} & \\ 
		\midrule
		\input{tables/liquidreg_sample_decrease_quarter_sell.tex} 
	}
...
\begin{table}[ht]\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (A): Price = \pounds0.11 to \pounds1.01} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_increase_bin1p_quarter_sell.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.01 to \pounds10.1} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_increase_bin10p_quarter_sell.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (C): Price = \pounds11 to \pounds101} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_increase_bin1pound_quarter_sell.tex} 
		}
	\end{adjustbox}
\end{table}
...
\begin{table}\footnotesize
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (B): Price = \pounds1.00 to \pounds10.0} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_bin10p_quarter_sell.tex} 
		}
	\end{adjustbox}
	...
	\begin{adjustbox}{center}
		\estauto{l c c c c c c  }<\multicolumn{6}{c}{Panel (C): Price = \pounds10 to \pounds100} \\>{
			...
			\multicolumn{1}{c}{(5)} & \\ 
			\midrule
			\input{tables/liquidreg_sample_decrease_bin1pound_quarter_sell.tex} 
		}
	\end{adjustbox}
\end{table}
