...
\begin{figure}[hbt!]
	...
	\fignote{£$Y$ in the X-axes is equivalent to £$X+1$ (e.g., £X9 could include £0.19, £1.9, £19, etc., while £Y0 could include £0.20, £2.0, £20, etc.). The figure exclude an atypical spike in sells on 2014-02-26 of stock  US92343V1044 (99.99\% of the total number of sales executed for that stock during the sample period). }
\end{figure}
