...
\usepackage[top=0.78in, bottom=0.75in, left=0.87in, right=0.87in]{geometry}
\usepackage{setspace}
...
\usepackage[noabbrev]{cleveref}	% clever ref; automatically adds "Figure," "Table," etc. when cross-ref. Need to place this after hyperref.
...
\newenvironment{response}{\vspace{12pt} \itshape}{\vspace{12pt}}
